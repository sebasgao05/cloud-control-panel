...
import { refreshInstances, openInstance, startCurrentInstance, stopCurrentInstance, updateCurrentInstance, openCurrentDashboard, clearActivity, setViewPreference } from './js/instances.js';
...
import { initUptimeChart, destroyUptimeChart, selectUptimeRange } from './js/uptime-chart.js';
import { initMetricsCharts, destroyMetricsCharts } from './js/metrics-chart.js';
...
Object.assign(window, {
    ...
    openInstance, startCurrentInstance, stopCurrentInstance, updateCurrentInstance, openCurrentDashboard, clearActivity, setViewPreference,
    ...
    initUptimeChart, destroyUptimeChart, selectUptimeRange,
    initMetricsCharts, destroyMetricsCharts,
